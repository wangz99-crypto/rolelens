...
|---|---|---|---|
| Competition | IBM AI Builders Challenge — August 2026 | DONE | `docs/official/官方规则.txt` covers the July and August monthly competitions |
| Track | Wildcard Challenge — Build Intelligent Systems for the Future of Work | DONE | Wildcard is available during both monthly competitions; RoleLens selected this theme |
| Participant mode | Solo student participant | NEEDS VERIFICATION | Confirm challenge-platform eligibility profile |
| Submission deadline | August 31, 2026 | DONE | Local official-rules capture states that August entries are due August 31 |
| Monthly submission limit | One project for the August monthly competition | DONE | Do not submit another project in the August monthly competition |

## Hard Requirements

| Requirement | Status | Completion evidence | Next gate |
|---|---|---|---|
| Working prototype or proof of concept | DONE | FastAPI product API, React frontend, and repository test suites | Preserve green verification through Competition Finish |
...
| AI is a core functional component | DONE | `app/granite_role_brief_provider.py`; `app/product_api.py`; provider and API tests | Demonstrate the bounded Granite role-brief path in the final submission |
...
| Public GitHub repository | DONE | `https://github.com/wangz99-crypto/rolelens` | Reconfirm logged-out access from the final submission page |
| Clear README with required sections | IN PROGRESS | Current `README.md` has setup and active identity; Competition Finish content remains | Complete the P1 competition README |
...
| No exposed credentials or private data | IN PROGRESS | Runtime credentials use ignored environment files; focused current tracked-file review found no live credential | Perform a separate historical-secret scan before final submission |
...
| Setup and run instructions | DONE | `README.md` contains backend and frontend quickstart commands |
...
|---|---|---|---|
| Technical execution | IN PROGRESS | Runnable FastAPI/React prototype and automated backend/frontend tests | Complete final submission verification and live reliability evidence |
...
Any Competition Finish re-score must use the runnable prototype and include this evidence package:
